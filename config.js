...
window.DS_ONE_CONFIG = Object.freeze({
  ...
  storage: Object.freeze({
    ...
    authTokenCacheKey: "ds_one_platform_sso_token_cache_v1",
    authTokenRefreshSkewMs: 30 * 1000,
    authIdentityCacheKey: "ds_one_platform_auth_identity_v1",
    authIdentityCacheTtlMs: 30 * 24 * 60 * 60 * 1000,
